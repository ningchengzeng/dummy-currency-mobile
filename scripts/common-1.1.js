...
function preheadUpdate(a, data, char) {
    ...
    if (0 == a) {
        document.title = data + ' BTC-比特币(币安) - 币小金';
    }
    if (old > data) {
