    ...
    r = {
        ...
        link: function(t, n, a) {
            if (r.path) {
                ...
                c = 0;
                s.rel = "stylesheet",
                s.href = r.path.replace('scripts','themes') + t.replace('default','default/css'),
                s.id = f,
        ...
        ready: function(e) {
            var t = "skinlayercss",
            i = "303";
            return a ? layui.addcss("modules/themes/default/layer.css?v=" + r.v + i, e, t) : r.link("default/layer.css?v=" + r.v + i, e, t),
            this
        },
